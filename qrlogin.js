...
function getqrpic(){
	cleartime();
	var getvcurl='http://43.140.245.243:1009/login.php?do=getqrpic&r='+Math.random(1);
...
function qrlogin(){
	...
	var url = 'http://43.140.245.243:1009/login.php?do=qrlogin&qrsig='+decodeURIComponent(qrsig)+'&r='+Math.random(1);
	$.get(url, function(d) {
		if(d.saveOK ==0){
